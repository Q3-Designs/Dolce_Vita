  ...
  return (
    <article
      ...
      className={`flex flex-col justify-center align-center pt-8 pb-8
       ...
       md:w-[100vw] md:max-w-[1400px] sm:max-w-[668px] text-gray-500
       ...
       animate={inView && hasAnimation? 'animate' : ''}
          ...
          ">
            ...
            <motion.p
             ...
             initial={hasAnimation ? 'initial' : ''}
             animate={inView && hasAnimation? 'animate' : ''}
             className="mt-6 text-left pl-5 sm:pl-12 sm:text-lg
             "
             >
              {description != null ? description[1] :
                ...
                <motion.button
                  ...
                  initial={hasAnimation ? 'initial' : ''}
                  animate={hasAnimation && inView ? 'animate' : ''}
                 className="mt-6 text-black text-sm
                 bg-white  hover:bg-gradient-to-b from-gold-light to-gold-dark
                 transition-all hover:text-white
                 hover:scale-[1.05] border border-gray-500 md:ml-0">{buttonText }
                 </motion.button>
                 </Link>
                         )}
            </motion.p>
