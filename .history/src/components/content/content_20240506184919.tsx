  ...
  return (
    <article
      ...
      className={`flex flex-col justify-center align-center pt-8 pb-8
       ...
       md:w-[100vw] md:max-w-[1200px] sm:max-w-[668px]
    ...
    >
      <motion.img
        ...
        className={`w-[90vw] h-[55vw] object-cover ml-auto mr-auto max-h-[567px] max-w-[668px] md:w-[60vw]
        ${reverse ? 'md:-translate-x(-3rem)' : ''}`}
        src={image}
      />
