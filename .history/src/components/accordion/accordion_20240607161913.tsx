    ...
    return (
        ...
        <section className='mt-[3rem]'>
            {text.map((text,index:number) => (
                ...
                className={`border-b-4 border-gold p-3 mb-3 transition-all
                w-[80%] ml-auto mr-auto
                hover:bg-gradient-to-b from-gold-light to-gold-dark hover:rounded-lg max-w-[500px]
                flex flex-col justify-center items-center ${expandedIndices.includes(index) ? 'bg-blue-400 rounded-lg' : ''}`}>
                    ...
                    className={`
                     duration-500 bg-gold-light text-left
