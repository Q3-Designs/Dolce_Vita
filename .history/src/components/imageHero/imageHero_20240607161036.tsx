...
const ImageHero: React.FC<HeroProps> = ({ images }) => {
    ...
    return (
        ...
        pb-10 h-screen ">
            ...
            md:flex md:flex-col md:justify-sta md:items-center
            mb-8 text-center">
...
<h1 className="text-4xl mb-4 mt-4 sm:text-6xl bg-gradient-to-b from-gold-light to-gold-dark bg-clip-text text-transparent font-dancing-script">
        Dolce Vita Construction
            ...
            <button className="bg-gradient-to-b from-gold-light to-gold-dark bg-clip-text text-transparent
            border border-black p-2
            rounded-sm hover:text-black hover:bg-red-200">
                Book a consultation
            </button>
            </Link>
            </div>
