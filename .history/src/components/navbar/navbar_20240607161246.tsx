         ...
         flex justify-between items-center border-b-4 border-[#F0EAD6] text-gray-500
          z-[210] text-white">
            ...
            z-[110]  ml-auto mr-auto">
                ...
                <p className="ml-2 lg:text-2xl mr-auto lg:mr-0 pl-6 lg:pl-0 bg-gradient-to-b from-gold-light to-gold-dark bg-clip-text text-transparent font-dancing-script
                ">Dolce Vita</p>
                </Link>
                <div
