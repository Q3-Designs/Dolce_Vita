...
import bed1 from '../../media/greyHome/grey-bathroom1.png'
import bed2 from '../../media/greyHome/grey-bathroom2.png'
import bath1 from 'src/media/greyHome/grey-bathroom1.png'
