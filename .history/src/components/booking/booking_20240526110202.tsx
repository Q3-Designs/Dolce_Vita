...
},
{
  ...
  index === inputFields.length - 1 ? (
    ...
    />
        ...
        <button className='bg-white hover:bg-main-color
        hover:text-white hover:scale-[1.0] transition all'>Send Message</button>
