          ...
          <div className="small">
            <div className="le-box">
              ...
              {submitted ? (
                ...
                <>
                  <p className="booking-p">Let's get in contact so we can build your awesome website</p>
                  <form onSubmit={sendEmail} ref={form}>
                    ...
                    <p className="pad3">
                      The laws of physics state that for every action, there is an equal and opposite reaction. Use
                      this law every day to create the reality you want.
                    </p>
