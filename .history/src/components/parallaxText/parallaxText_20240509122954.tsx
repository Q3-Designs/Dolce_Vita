...
const StickyImage = ({ imgUrl }: { imgUrl: string }) => {
  ...
  return (
    ...
    >
       Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minima nobis beatae provident eligendi quidem repudiandae corporis recusandae, quibusdam quo ut.
      <motion.div
