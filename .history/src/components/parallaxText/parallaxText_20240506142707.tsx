...
export const TextParallaxContentExample = () => {
  return (
    <div className=" relative">
      <TextParallaxContent
        imgUrl={home1}
        subheading="Our really cool home"
...
const OverlayCopy = ({
  ...
  const TextExample1: React.FC = () => {

    return (
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12 bg-red-200">
